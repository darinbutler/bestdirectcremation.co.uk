...
export const GAP_PAGES: GapPage[] = [
...

  {
    ...
    serviceNoun: 'direct cremation',
    intentMatch: 'The best-value alternative to Co-op Funeralcare — Best Direct Cremation £1,499 with a personally-vetted local funeral director',
    longForm: [
      pt(`Co-op Funeralcare is the UK's largest national funeral chain — but at around £1,895-£1,995 for a direct cremation, they're materially more expensive than Best Direct Cremation's £1,499 all-inclusive price. And where Co-op sends you into their own branch network, Best Direct Cremation appoints a genuinely local independent funeral director who we have personally vetted and who lives and works in your area. If you're looking for the best alternative to Co-op Funeralcare, this page explains why families increasingly choose us instead.`),

      h2('Why families switch from Co-op Funeralcare to Best Direct Cremation'),
      pt(`Three reasons come up again and again on our 24-hour phone line. First: the price. £1,499 all-inclusive with a transparent maximum of £1,749 saves families £400-£500 versus Co-op — money most families put toward a proper personal memorial afterwards.`),
      pt(`Second: the funeral director themselves. When you call Co-op, you go into their national branch network. When you call us, we appoint a specific local independent funeral director who we have personally interviewed, whose premises we have inspected, and whose service quality we monitor continuously. You are not being handed off to a random branch — you are being appointed a professional we know by name and stand behind.`),
      pt(`Third: the 24-hour real person. We answer 0333 242 1405 ourselves, 24 hours a day, every day. Bereavement does not wait for opening hours.`),

      h2('The personal-vetting difference'),
      pt(`Every funeral director in our UK network has been personally vetted before joining. That process is not a rubber-stamp accreditation check. It includes: a full review of their NAFD or SAIF membership and standing; an inspection of their premises and mortuary facilities; a review of their service quality and complaint history; conversations with families they have previously served; and an ongoing audit of standards after they join our network. Any partner who slips below our standards is removed.`),
      pt(`Co-op's branch network is Co-op-employed staff following Co-op procedures. That gives consistency, but it also means the family in Cornwall gets the same treatment as the family in Glasgow — regardless of what the local team is actually like. Our model gives you the best of both: nationally consistent price and service standards, delivered by a specific local professional we know and trust.`),

      h2('Co-op Funeralcare pricing vs Best Direct Cremation'),
      pt(`Best Direct Cremation: £1,499 all-inclusive, maximum £1,749 with Priority Care. Same price everywhere in the UK. Disclosed on the first call.`),
      pt(`Co-op Funeralcare: approximately £1,895-£1,995 for a Simple Direct Cremation, with regional variation. Some Co-op branches disclose out-of-hours or Priority Care equivalent fees at the point of need rather than upfront.`),
      pt(`The saving with Best Direct Cremation is £400-£500 minimum. In some cases more, once Co-op regional supplements and Priority Care equivalents are added.`),

      h2('What you get with Best Direct Cremation that you don\'t get with Co-op'),
      pt(`A funeral director you can meet in your local area — not a corporate branch. Every partner in our network is an independent business owner, personally invested in their community's reputation of them. If something goes wrong, they answer for it locally — not to a distant head office.`),
      pt(`The closest local crematorium, chosen by your local funeral director based on availability and proximity to home. Not a Co-op procurement decision.`),
      pt(`24-hour real-person phone coverage — us, not a branch answering machine or an outsourced call centre.`),
      pt(`Full transparency on the maximum you could pay. £1,749 is our ceiling, disclosed at the outset.`),
      pt(`NAFD or SAIF accreditation on every partner. Standards continuously monitored by our team, not left to the local branch.`),

      h2('What Co-op offers that we don\'t'),
      pt(`A high-street branch you can physically walk into. Some families genuinely value this. If you want to sit down in a Co-op branch and meet the funeral director in person before signing anything, that is what Co-op is for. Our model is phone-arranged; the local funeral director attends collection but you may not meet them face to face beforehand unless you request it.`),
      pt(`Immediate ability to upgrade to a full traditional attended funeral. If you might change your mind mid-process and want the option of full ceremony, Co-op's branch model handles this pivot slightly more smoothly. That said, our partner funeral directors can also arrange attended cremation and traditional funerals — just ask when you call and we will discuss options honestly.`),

      h2('Switching from Co-op — the practical steps'),
      pt(`If you have been quoted by Co-op but haven't signed anything: call us on 0333 242 1405 straight away. We take a few essential details, appoint your local personally-vetted funeral director within an hour, and take it from there. No paperwork with Co-op required.`),
      pt(`If you have signed a Co-op arrangement and now want to switch: contact Co-op to cancel. Depending on how far the arrangement has progressed there may be an administrative fee. Then call us. The £400-£500 saving makes the switch worthwhile in almost every case.`),

      h2('Why choosing an alternative to Co-op is not "cutting corners"'),
      pt(`Some families worry that anything cheaper than a national brand must be lower quality. This is not the case with Best Direct Cremation. Every partner in our UK-wide network is NAFD- or SAIF-accredited (the two main UK professional bodies), personally vetted by us, and continuously audited. The cremation itself is at a proper UK crematorium regulated under the Cremation (England and Wales) Regulations 2008 or the Scottish equivalent. The coffin is proper wood, not cardboard. The care is identical in professional dignity to any Co-op arrangement.`),
      pt(`The saving comes from cutting national-brand branch overhead, not from cutting corners on care. Around 1 in 5 UK families now choose independent-network operators like us — the model is mainstream and reputable.`),

      ...closingCTA,
    ],
    faqs: [
      { q: 'What is the best alternative to Co-op Funeralcare?', a: 'Best Direct Cremation. £1,499 all-inclusive (max £1,749 with Priority Care), delivered by a personally-vetted local independent funeral director we know by name. £400-£500 less than Co-op\'s direct cremation service, without the national-chain overhead.' },
      { q: 'How much cheaper is Best Direct Cremation than Co-op?', a: 'Around £400-£500 cheaper minimum. Co-op\'s direct cremation is £1,895-£1,995. Ours is £1,499 all-inclusive with a maximum ceiling of £1,749 including Priority Care.' },
      { q: 'How do you vet your partner funeral directors?', a: 'Every partner is personally interviewed and their premises inspected before joining our network. We check NAFD or SAIF accreditation, service history, family references, and complaint records. Ongoing audits maintain standards. Any partner who slips is removed.' },
      { q: 'Can I switch from Co-op to Best Direct Cremation?', a: 'Yes. If you have not signed with Co-op yet, just call us on 0333 242 1405. If you have already signed, you would need to cancel the Co-op arrangement first — worth it for the saving in almost every case.' },
      { q: 'Do you use the same crematoria as Co-op?', a: 'Yes — the same local crematoria, chosen by your local funeral director based on proximity and availability. We do not have "our own" crematoria the way some centralised operators do.' },
      standardFaqSeed.q2,
    ],
  },
