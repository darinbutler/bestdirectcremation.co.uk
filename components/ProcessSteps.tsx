          ...
          {STEPS.map(step => (
            <li key={step.n} className="flex flex-col">
              <div className="relative w-full aspect-[4/3] rounded-card overflow-hidden shadow-card mb-4">
                ...
                <div className="absolute top-3 left-3 inline-flex items-center justify-center w-9 h-9 rounded-full bg-gold text-white font-serif text-lg shadow-lift">{step.n}</div>
              </div>
