    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur border-b border-stone">
      <Container className="flex items-center justify-between py-3 md:py-4 gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:block"><PhoneCTA size="sm" variant="gold" /></div>
          <a href={SITE.phoneHref} aria-label="Call us" className="sm:hidden inline-flex items-center justify-center w-10 h-10 rounded-full bg-gold text-white">
